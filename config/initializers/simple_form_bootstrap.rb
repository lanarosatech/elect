...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check form-check-question', item_label_class: 'form-check-label form-check-label-question', tag: 'fieldset', class: 'mb-3' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
    end
    b.use :input, class: 'form-check-input form-check-input-question', error_class: 'is-invalid', valid_class: 'is-valid'
    b.use :full_error, wrap_with: { class: 'invalid-feedback d-block' }
    b.use :hint, wrap_with: { class: 'form-text' }
  end

  # vertical input for inline radio buttons and check boxes
  config.wrappers :vertical_collection_inline, item_wrapper_class: 'form-check form-check-question form-check-inline', item_label_class: 'form-check-label form-check-label-question', tag: 'fieldset', class: 'mb-3' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
  ...
  config.wrappers :horizontal_collection, item_wrapper_class: 'form-check form-check-question', item_label_class: 'form-check-label form-check-label-question', class: 'row mb-3' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label pt-0'
    b.wrapper :grid_wrapper, class: 'col-sm-9' do |ba|
      ba.use :input, class: 'form-check-input form-check-input-question', error_class: 'is-invalid', valid_class: 'is-valid'
