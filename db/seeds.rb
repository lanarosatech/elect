...
# file = URI.open('https://www.camara.leg.br/internet/deputado/bandep/pagina_do_deputado/204526.jpg')
...
#   'candidate', state: 'Paraíba', party: 'PT', name: 'Frei Anastacio Ribeiro')
...
#   'candidate', state: 'Piauí', party: 'PSD', name: 'Marcos Aurélio Sampaio')
